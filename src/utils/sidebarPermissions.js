...
const SIDEBAR_PERMISSIONS = {
  ...
  "/booking": [PERMISSION_KEYS.BOOKING_READ, PERMISSION_KEYS.BOOKING_READ_ALL],
  "/subscriptions": [PERMISSION_KEYS.SUBSCRIPTION_READ, PERMISSION_KEYS.SUBSCRIPTION_READ_ALL],
  ...
  "/special-offers": [PERMISSION_KEYS.OFFER_READ, PERMISSION_KEYS.OFFER_READ_ALL],
  "/payments": [PERMISSION_KEYS.PAYMENT_READ, PERMISSION_KEYS.PAYMENT_READ_ALL],
  "/settings": null,
